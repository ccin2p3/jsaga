...
public class LocalUserPIP implements ServicePIP {
    ...
    public static final Pattern uidPattern = Pattern.compile("uid=\\d+\\((\\w+)\\)");
    public static final Pattern gidPattern = Pattern.compile("gid=\\d+\\((\\w+)\\)");
    public static final Pattern groupsPattern = Pattern.compile("groups=(\\S+)");
    public static final Pattern groupsSubPattern = Pattern.compile("\\d+\\((\\w+)\\)");
