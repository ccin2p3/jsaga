...
public interface JobDBInterface {
    public static final String JOB_DATABASE_NAME = "creamdb";
    public static final String JOB_DATASOURCE_NAME = "java:comp/env/jdbc/creamdb";
     ...
     * @param endRegisterCommandEndDate It refers to the JobCommandTable.CREATION_TIME_FIELD for JobCommandTable.TYPE_FIELD=0
    ...
    public List<String> retrieveJobId(String userId, String delegationId, int[] jobStatusType, 
    		Calendar registerCommandStartDate, Calendar registerCommandEndDate, String leaseId, 
    		Calendar startStatusDate, Calendar endStatusDate) throws DatabaseException, IllegalArgumentException;
     ...
     * @throws IllegalArgumentException
     */
    public List<Event> retrieveJobStatusAsEvent(String fromJobStatusId, String toJobStatusId, Calendar fromDate, Calendar toDate, int maxElements, String userId) throws DatabaseException, IllegalArgumentException;
