...
public final class JobStatus {
    ...
    public static final String[] statusName = new String[] { "REGISTERED", "PENDING", "IDLE", "RUNNING", "REALLY-RUNNING", "CANCELLED", "HELD", "DONE-OK", "DONE-FAILED", "PURGED",
            "ABORTED" };
    ...
    public JobStatus(int type, String jobId, Calendar timestamp) {
        this.type = type;
        this.jobId = jobId;
