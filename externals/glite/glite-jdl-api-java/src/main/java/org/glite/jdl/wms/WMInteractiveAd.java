 ...
 *
 * Version info: $Id: WMInteractiveAd.java,v 1.2 2006/10/26 14:52:49 pandreet Exp $
 */
...
public class WMInteractiveAd extends JobAd implements WMExtensions {

    private CommonAd innerAd;

    public WMInteractiveAd(){
        super();
        innerAd = new CommonAd();
    }

    public WMInteractiveAd(RecordExpr expr) throws JobAdException {
    ...
    public Object clone(){
        WMInteractiveAd result = new WMInteractiveAd();
        fillJobAd(result);
