...
public class Jdl {
    ...
    public static final String MAX_OUTPUT_SANDBOX_SIZE = "MaxOuputSandboxSize";
    ...
    public static final String SHALLOWRETRYCOUNT = "ShallowRetryCount";
    ...
    public static final String DATA_REQUIREMENTS = "DataRequirements";
    public static final String DATA_CATALOG_TYPE = "DataCatalogType";
    ...
    public static final String NODES_COLLOCATION = "NodesCollocation";
