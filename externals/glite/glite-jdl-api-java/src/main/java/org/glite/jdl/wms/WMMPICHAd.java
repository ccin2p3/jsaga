 ...
 *
 * Version info: $Id: WMMPICHAd.java,v 1.2 2006/10/26 14:52:49 pandreet Exp $
 */
...
import org.glite.jdl.core.MPICHAd;
import org.glite.jdl.JobAdException;

public class WMMPICHAd extends MPICHAd implements WMExtensions {
    ...
    public WMMPICHAd(RecordExpr expr) throws JobAdException {
    ...
    public Object clone(){
        WMMPICHAd result = new WMMPICHAd();
        fillJobAd(result);
