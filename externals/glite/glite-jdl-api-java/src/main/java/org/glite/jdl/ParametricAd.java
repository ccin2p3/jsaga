 ...
 *
 * Version info: $Id: ParametricAd.java,v 1.12 2006/09/12 11:27:21 pandreet Exp $
 */
...
public class ParametricAd extends JobAd implements Cloneable, EnumerableAd {
    ...
    private static Logger logger = Logger.getLogger(ParametricAd.class.getName());
    ...
    public Object clone() {
		try {
            ...
            logger.debug(jobEx.getMessage(), jobEx);
		}
