...
public abstract class BaseServer implements Runnable {
    ...
    public synchronized GSSCredential getCredentials() {
	return this.credentials;
    }
    
    public synchronized void setCredentials(GSSCredential credentials) {
	...
	ExtendedGSSContext context = 
	    (ExtendedGSSContext)manager.createContext(getCredentials());
