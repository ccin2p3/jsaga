...
public class GlobusGSSName implements GSSName, Serializable {
    ...
    private static LoadingCache<String, String> resolved = CacheBuilder.newBuilder()
       .maximumSize(CacheSize)
       .expireAfterWrite(CacheTime, TimeUnit.MINUTES)
       .build(
           new CacheLoader<String, String>() {
             public String load(String name) throws UnknownHostException {
    ...
    private static Pattern ipPattern = Pattern.compile("\\b(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\b");
	...
	if (name == null) {
		...
		if (nameType.equals(GSSName.NT_HOSTBASED_SERVICE)) {
		    ...
		    String host;
		    try {
                        host = resolved.get(name.substring(atPos+1));
