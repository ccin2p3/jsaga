 ...
 *
 */
public class RByteIODataAdaptor extends UnicoreAbstract implements FileWriterPutter, FileReaderGetter {
...
/*        } catch (GPEMiddlewareRemoteException e) {
    ...
    public FileAttributes getAttributes(String absolutePath, String additionalArgs) throws PermissionDeniedException, DoesNotExistException, TimeoutException, NoSuccessException {
		...
		try {
			GridFileType gft = m_client.listProperties(absolutePath);
			return new RByteIOFileAttributes(gft, m_serverFileSeparator);
		} catch (BaseFault e) {
			e.printStackTrace();
			throw new NoSuccessException(e);
		} catch (FileNotFoundException e) {
    ...
    public FileAttributes[] listAttributes(String absolutePath, String additionalArgs) throws PermissionDeniedException, DoesNotExistException, TimeoutException, NoSuccessException {
    	...
    	try {
			...
			for (GridFileType gft : _list) {
				attrs[i++] = new RByteIOFileAttributes(gft, m_serverFileSeparator);
			}
			return attrs;
		} catch (BaseFault e) {
			throw new NoSuccessException(e);
