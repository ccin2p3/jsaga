 ...
 *
 */
public class NaregiSecurityCredential extends UserPassSecurityCredential implements SecurityCredential {
    private boolean m_hasBackup;
    private String m_certRepositoryBackup;

    public NaregiSecurityCredential(String userId, String userPass, String certRepository) {
