...
public class VOMSMyProxySecurityCredential extends VOMSSecurityCredential {
    ...
    public VOMSMyProxySecurityCredential(GSSCredential proxy, File certRepository, File userProxyFilename, Map attributes) {
        super(proxy, certRepository, userProxyFilename);
