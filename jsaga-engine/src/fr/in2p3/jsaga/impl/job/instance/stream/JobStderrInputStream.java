...
public class JobStderrInputStream extends Stdout {
    ...
    public JobStderrInputStream(JobImpl job, JobIOHandler ioHandler) throws NotImplementedException, DoesNotExistException, TimeoutException, NoSuccessException {
        m_job = job;
        ...
        switch(m_job.getJobState()) {
            ...
            case RUNNING:
                ...
                break;
            default:
                throw new DoesNotExistException("Stderr is not available because job is neither finished nor running: "+m_job.getState());
        }
    }
                ...
                case RUNNING:
                    if (m_stream == null) {
                        if (m_ioHandler instanceof JobIOGetter) {
                            ...
                            throw new NoSuccessException("Can not read from stderr because job is running and adaptor does not support job interactivity");
                        }
                    }
                    return m_stream;
                default:
