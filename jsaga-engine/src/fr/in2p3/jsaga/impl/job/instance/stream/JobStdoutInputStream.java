...
public class JobStdoutInputStream extends Stdout {
    ...
    public JobStdoutInputStream(AbstractSyncJobImpl job, JobIOHandler ioHandler) throws NotImplementedException, DoesNotExistException, TimeoutException, NoSuccessException {
        m_job = job;
    ...
    protected JobStdoutInputStream(AbstractSyncJobImpl job) {
        m_job = job;
    }
