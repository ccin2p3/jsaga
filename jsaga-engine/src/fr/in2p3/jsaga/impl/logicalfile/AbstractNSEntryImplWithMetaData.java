...
public abstract class AbstractNSEntryImplWithMetaData extends AbstractNSEntryImpl implements NSEntry, AsyncAttributes {
    ...
    public AbstractNSEntryImplWithMetaData(AbstractNSEntryImpl entry, URL url, int flags) throws NotImplemented, IncorrectURL, AuthenticationFailed, AuthorizationFailed, PermissionDenied, BadParameter, DoesNotExist, Timeout, NoSuccess {
