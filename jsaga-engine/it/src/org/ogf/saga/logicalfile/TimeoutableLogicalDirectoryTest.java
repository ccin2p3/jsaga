 ...
 * ***             http://cc.in2p3.fr/             ***
 * ***************************************************
 * File:   TimeoutableLogicalDirectoryTest
 ...
 *
 */
public class TimeoutableLogicalDirectoryTest extends JSAGABaseTest {
    private static final String m_url = "waitforever-logical://host/directory/";
    private static Logger s_logger = Logger.getLogger(TimeoutableLogicalDirectoryTest.class);
    private LogicalDirectory m_directory;

    public TimeoutableLogicalDirectoryTest() throws Exception {
        super();
    }
