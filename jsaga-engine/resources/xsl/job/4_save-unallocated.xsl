...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="jsdl:JobDescription">
        ...
        <xsl:choose>
            ...
            <xsl:when test="ext:SelectedResource and contains($jobname,'@{INDICE}') and $nbslots&lt;$nbjobs">
                <JobDescription>
    ...
    <xsl:template match="ext:Parametric">
        <xsl:variable name="nbslots" select="count(/jsdl:JobDefinition/jsdl:JobDescription[contains(jsdl:JobIdentification/jsdl:JobName/text(),'@{INDICE}')]/ext:SelectedResource)"/>
        <ext:Parametric>
